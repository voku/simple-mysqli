 ...
 * @internal
 */
final class SimpleDoctrinePdoTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var DB
     */
    ...
    protected function setUpNonVoid()
    {
        $connectionParams = [
            ...
            'user'     => 'root',
            'password' => '',
            'host'     => simple_mysqli_test_db_host(),
            'driver'   => 'pdo_mysql',
            'charset'  => 'utf8mb4',
        ];
    ...
    public function testEscapeData()
    {
        ...
        $dbTmp = DB::getInstance(simple_mysqli_test_db_host(), 'root', '', 'mysql_test', 3306, 'utf8', false, false);

        static::assertSame('NULL', $this->db->escape(null, true));
        static::assertSame(\mysqli_real_escape_string($dbTmp->getLink(), "O'Toole"), $dbTmp->escape("O'Toole"));
        static::assertSame(\mysqli_real_escape_string($dbTmp->getLink(), "O'Toole"), $dbTmp->escape("O'Toole", true));
